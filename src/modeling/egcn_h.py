"""EGCN-H (Evolving Graph Convolutional Network - History variant) model definition.

Implements evolving graph convolutions with historical context for temporal graphs.
...
class EGCN(torch.nn.Module):
    """Evolving Graph Convolutional Network with history."""

    def __init__(self, args, activation, device="cpu", skipfeats=False):
        """Initialize EGCN-H model.
...
class GRCU(torch.nn.Module):
    """Graph Recurrent Convolution Unit."""
...
class mat_GRU_cell(torch.nn.Module):
    """Matrix-based GRU cell for weight evolution."""
