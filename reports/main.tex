...
% TODO: Per il font bello, ma serve lualatex per compilare, da risolvere dopo
% \usepackage{fontspec}
...
\titleformat{\chapter}[hang]{\Huge\bfseries}{\selectfont \thechapter\hsp\textcolor{cyan}{|}\hsp}{0pt}{\Huge\bfseries}
