...
The available data are being collected from the social network platform Gab\footnote{\url{https://gab.com/}}, known for its minimal content moderation policies and popularity among far-right communities, over a defined time period.
...
\begin{itemize}
	...
	\item The graph is directed and unweighted
...
\begin{itemize}
	...
	\item Analyze the generated network properties, including degree distribution, clustering coefficient, and average path length.
\end{itemize}

\subsection*{Success Criteria}
\label{sec:datamining_success}
...
\begin{itemize}
	...
	\item Providing comprehensive insights about the generated network's structural properties.
\end{itemize}